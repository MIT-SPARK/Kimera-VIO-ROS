...
class GTLoggerNode:
    def __init__(self):
        ...
        rospy.Subscriber(self.gt_topic, PoseStamped, self.gt_cb_pose, queue_size=20)
        self.setup_gt_file()

    def gt_cb_pose(self, msg):
        """ Callback for ground-truth poses as they come in as PoseStamped
            msgs.
            ...
            Args:
                ...
                msg: A geometry_msgs/PoseStamped object representing
