...
class DeltasLoggerNode:
    def __init__(self):
        ...
        self.image_topic = rospy.get_param("~left_cam_topic")
        self.image_output_csv_file = os.path.join(self.output_dir, "timestamps_infra1.csv")
...
if __name__ == "__main__":
    rospy.init_node("infra1_logger_node")
